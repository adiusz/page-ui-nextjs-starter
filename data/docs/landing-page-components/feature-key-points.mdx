import { LandingGridPatternCtaBg } from "../../../components/landing";summary: 'A component meant to be used in the landing page. This component displays bullet points (key features) in the description of LandingProductFeature.'
layout: PostHub
